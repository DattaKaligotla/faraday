export interface JobInput {
  ...
  toolCalls?: unknown;
  /** End-user tenant (org) id from the SDK claims, if any. Used to look up tenantMemory. */
  orgId?: string | null;
  /** End-user tenant display name, if known from the request record. */
  orgName?: string | null;
  /** Customer-authored markdown brief about this end-user tenant. Inlined into the user prompt. */
  tenantMemory?: string;
}

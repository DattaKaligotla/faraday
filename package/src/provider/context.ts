...
export type FormSubmitHandler = (formId: string, values: Record<string, FormDataEntryValue>) => void | Promise<void>;

export const AgentFormContext = createContext<FormSubmitHandler | undefined>(undefined);

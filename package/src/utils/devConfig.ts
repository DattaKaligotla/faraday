...
export function getDevEndpoint(): string | undefined {
  return readImportMetaEnv("VITE_FARADAY_ENDPOINT") ?? readProcessEnv("FARADAY_ENDPOINT");
}

/** Local-dev override for the SaaS API base URL. */
export function getDevApiUrl(): string | undefined {
  return readImportMetaEnv("VITE_FARADAY_API_URL") ?? readProcessEnv("FARADAY_API_URL");
}
